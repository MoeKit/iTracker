// http://s0.meituan.net/vendor/js/mta.js
...
(function(window, document) {
    ...
    Client.prototype = {
        ...
        _hashInfo: function() {
            ...
            navigator = navigator.appName + navigator.version + this.language + navigator.platform + navigator.userAgent + this.javaEnabled + this.screen + (document.cookie ? document.cookie : "") + (document.referrer ? document.referrer : "");
    ...
    Beacon.prototype = {
        ...
        send: function(data, callback) {
            ...
            if (dataStr.length <= Beacon.MAX_URL_LENGTH) {
                this._sendByScript(dataStr, callback);
            } else {
                var error = {
                    app: 'performance',
                    type: 'combo',
                    data: [{
                        ...
                        category: 'mtajs',
                        data: {
                            beaconLength: dataStr.length
                        }
                    }]
                };
                this._sendByScript(util.buildQueryString(error), callback);
            }
        },
        _sendByScript: function(param, callback) {
    ...
    Tracker.prototype = {
        ...
        /**
         * push data to queue
         * if the queue exceeds max url length, send immediately
         */
        _push: function(data) {
            ...
            payload.data = this._queue.concat(data);
    ...
    Tracker.addPlugin('page', {
        ...
        data: function() {
            ...
            var data = {
                ...
                ttfb: timing.responseStart - timing.navigationStart, // 完全加载全过程
